...
using AuthServiceAngel.Api.Extensions;
using AuthServiceAngel.Api.ModelBinders;
using Serilog;
...
{
    options.ModelBinderProviders.Insert(0, new FileFataModelBinderProvider());
})
.AddJsonOptions(o =>
{
